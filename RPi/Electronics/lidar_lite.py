...
class Lidar_Lite():
    ...
    def getDistance(self):
        self.write(self.distWriteReg, self.distWriteVal)
        dist = self.readDist(self.distReadReg)
        return dist

    def getVelocity(self):
        self.write(self.distWriteReg, self.distWriteVal)
        self.write(self.velWriteReg, self.velWriteVal)
        vel = self.readVel(self.velReadReg)
